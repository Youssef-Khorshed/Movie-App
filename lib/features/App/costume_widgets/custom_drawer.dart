      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(
              icon:
                  "https://s3-alpha-sig.figma.com/img/185b/be5d/2d7f708e2b3300d041d00e200ca6f2a0?Expires=1733702400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=UovcClShSHe6Z0UFyK4r5nICoZvC7Bw6lC9d6~Y5UvlnfolBTO5GzYTxkXcNIyJJ8hkElQZOLGLfNKCtwSW00Ld27JjhB9KdaokxvaXxD5aEsc5iHq2jjO5NMX3cnyE8hE0lmzRvHEKYpzo6d1m9uLh9MZMtOhaCdqpzkzpjE1riub00rVWU6JyzWAoUEH7G3u5UoGn0g91jh6l9WgZMdPR5M26K771L5sszya4GURdUdAr7h6GlPSk~Rjyu2A8Hd3V-2plhd4QD2FjspJtQ2u31Yyc2XzTbCEgO0Y1mr0L363Y462fzT6kFmao~103rnjPVLLXCnvU1yZ0~IMTO9A__",
  ...
  Widget _buildDrawerItem({
    ...
    return Column(
      children: [
        Container(
          height: 1,
          color: AppColors.darkpurple, // Line above the item
        ),
        ListTile(
        ...
        Container(
          height: 1,
          color: AppColors.darkpurple, // Line below the item
        ),
      ],
    );
  }
